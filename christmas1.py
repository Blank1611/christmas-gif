# -*- coding: utf-8 -*-
"""
Created on Mon Dec 24 23:06:08 2018
...
text.write("Sathyabama", font=("Avenir", 30, "bold"), align="right") 
text.color("black") 
text.write("Coding Club", font=("Avenir", 30, "normal"), align="left") 
text.setx(50)
text.setposition(20, 150) 
text.write("from", font=("Apple Chancery", 15, "bold"), align="right") 
text.hideturtle() 
